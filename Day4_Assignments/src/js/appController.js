  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'TextBinding_Assign_1', detail: { label: 'Text Binding', iconClass: 'oj-ux-ico-fire' } },
        { path: 'ojbindclick_Assign_2', detail: { label: 'OJ Bind Click', iconClass: 'oj-ux-ico-contact-group' } },
        { path: 'ValButton_Assign_3', detail: { label: 'Validate Button', iconClass: 'oj-ux-ico-information-s' } }
      ];
